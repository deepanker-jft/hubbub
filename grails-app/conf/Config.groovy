...
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.grailsaction.UserRole'
grails.plugin.springsecurity.authority.className = 'com.grailsaction.Role'
